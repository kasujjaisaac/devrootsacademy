    ...
    <div>
            ...
            <div class="ad-card-body">
                ...
                <div class="ad-form-row">
                    ...
                    <div class="ad-form-group">
                        ...
                        <input type="text" name="slug" id="slugInput"
                               ...
                               required>
                        <p class="ad-input-hint">Auto-generated from title. Must be unique.</p>
                ...
                <div class="ad-form-group">
                    ...
                    <textarea name="short_description" id="shortDesc"
                              ...
                              rows="2"
                              maxlength="500"
                              placeholder="One or two sentences summarising the course (used on cards)...">{{ old('short_description') }}</textarea>
        ...
        <div class="ad-card">
            ...
            <div class="ad-card-body">
                ...
                <textarea name="outline" id="outlineData" hidden>{{ old('outline') }}</textarea>
            ...
            <div class="ad-card-body">
                ...
                <div class="ad-form-group" style="margin-top:16px;margin-bottom:0;">
                    ...
                    <input type="date" name="enrollment_close_date"
                           ...
                           value="{{ old('enrollment_close_date') }}">
                    <p class="ad-input-hint">Leave empty if applications should stay open until you close them manually.</p>
        ...
        <div class="ad-card">
            ...
            <div class="ad-card-body">
                <div class="cf-upload-zone" id="uploadZone">
                    ...
                    <div class="cf-upload-text"><strong>Click to upload</strong> or drag &amp; drop</div>
                    <div class="cf-upload-hint">JPG, PNG, WEBP — max 2 MB</div>
                </div>
                <img id="imgPreview" class="cf-img-preview" src="" alt="Preview">
...
const existingDesc = document.getElementById('descInput').value;
if (existingDesc) {
...
// Restore old outline values
const oldOutline = outlineData.value.trim();
if (oldOutline) {
