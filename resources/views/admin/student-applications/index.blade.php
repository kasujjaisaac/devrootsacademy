...
<div class="ad-stats-row" style="grid-template-columns:repeat(auto-fit,minmax(150px,1fr));margin-bottom:20px;">
    <a href="{{ route('admin.student-applications.index') }}" class="ad-stat-card blue" style="text-decoration:none;">
        <div>
    ...
    @foreach($statusLabels as $statusKey => $label)
        <a href="{{ route('admin.student-applications.index', ['status' => $statusKey]) }}"
...
<div class="ad-card">
    <div class="ad-table-toolbar">
        <div class="ad-search-box">
            ...
            <input class="ad-table-search" data-table="applicationsTable" placeholder="Search applications...">
        </div>
    </div>
    <div class="ad-table-wrap">
        <table class="ad-table" id="applicationsTable">
            <thead>
                <tr>
                    <th class="cell-sm">#</th>
                    <th>Applicant</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="font-size:0.75rem;color:var(--ad-muted);">{{ $application->email ?: $application->phone }}</div>
                    </td>
                    <td>{{ $application->course?->title ?? 'Course unavailable' }}</td>
                    <td>
                    ...
                    <td>
                        <a href="{{ route('admin.student-applications.show', $application) }}" class="btn-ad btn-ad-outline btn-ad-sm">
