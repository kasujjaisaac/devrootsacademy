...
@section('content')
<div class="mb-8">
    <h1 class="text-2xl font-bold">Support Inbox</h1>
    <p class="text-gray-500">Student support conversations ordered by unread activity</p>
</div>
    ...
    <table class="min-w-full text-sm">
        <thead>
            <tr class="border-b">
                ...
                <th class="py-2 px-4 text-left">Assigned Admin</th>
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-gray-50">
                ...
                <td class="py-2 px-4">{{ $chat->admin->name ?? 'Unassigned' }}</td>
